...
<div class="flex justify-center mt-4 relative">
    <Card class="filter {loading ? 'blur-[2px]' : ''}">
    ...
    {#if loading}
        <div role="status" class="absolute top-0 left-0 right-0 h-full flex items-center justify-center z-10">
            <svg aria-hidden="true" class="w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
